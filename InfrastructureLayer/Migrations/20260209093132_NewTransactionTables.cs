...
{
    /// <inheritdoc />
    public partial class NewTransactionTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adjustments_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Adjustments_Organizations_OrganizationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoice_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Adjustments_ClientId",
                table: "Adjustments",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Adjustments_OrganizationId_Date",
                table: "Adjustments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Discounts_OrganizationId_Date",
                table: "Discounts",
                columns: new[] { "OrganizationId", "Date" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoice_OrganizationId_InvoiceNumber",
                table: "Invoice",
