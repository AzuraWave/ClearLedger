...
namespace PresentationLayer.Pages.Customer.Statement
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(ITransactionService transactionService, IStatementDocumentGenerator statementDocumentGenerator, IStatementExcelGenerator statementExcelGenerator)
        {
